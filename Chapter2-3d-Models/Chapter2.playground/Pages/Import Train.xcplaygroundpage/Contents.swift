...
guard let assetURL = Bundle.main.url(forResource: "train", withExtension: "obj")
else {
  fatalError()
}
...
guard let mdlAttributeAtZero = (meshDescriptor.attributes[0] as? MDLVertexAttribute) else {
  fatalError()
}
mdlAttributeAtZero.name = MDLVertexAttributePosition
